            ...
            <div class="card-body">
                ...
                <div class="mb-5"> <label class="fs-6 form-label fw-bolder text-dark">Status</label>
                    <select class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-placeholder="In Progress" data-hide-search="true" data-select2-id="select2-data-10-lo7h" tabindex="-1" aria-hidden="true">
                        ...
                        <option value="2">In-Active</option> </select> </div>
                <div class="mb-5"> <label class="fs-6 form-label fw-bolder text-dark">Commodity ID</label>
                    <select class="form-select form-select-solid select2-hidden-accessible" id='selComm'>
                        <option value='0'>Select an option</option>
                    </select>
                </div>
                <div class="d-flex align-items-center justify-content-end">
                    <a href="#" class="btn btn-active-light-primary btn-color-gray-400 me-3">Discard</a> <a href="#" class="btn btn-primary">Search</a> </div>
            </div>
        </div>
    </form>
</div>
