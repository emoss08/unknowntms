<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="mb-10 bg-light-info p-8 rounded"><div class="text-info"> <strong>Unknown TMS</strong> is currently in BETA <strong>v0.0.1</strong>. Report any bugs to <u><strong>Admin@unknown.io</strong></u></div></div>
