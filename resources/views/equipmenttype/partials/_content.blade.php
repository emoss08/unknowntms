                ...
                <div class="d-flex flex-stack mb-5">
                    ...
                    <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                        ...
                        @can('equipment-type-create')
                            <button type="button" class="btn btn-light-primary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#create-equipment-type">
                                ...
                                <!--end::Svg Icon-->Add Equipment Type</button>
                    @endcan
                    <!--end::Add customer-->
