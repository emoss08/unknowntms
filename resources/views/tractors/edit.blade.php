            ...
            <div class="card-body">
                        ...
                        <div class="row fv-row">
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                        data-placeholder="{{ $tractor->status }}" name="status">
                                    <option></option>
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="tractor_id"
                                       id="kt_docs_maxlength_always_show" maxlength="15"
                                       value="{{ $tractor->tractor_id }}" required/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        </div>
                        ...
                        <div class="row fv-row">
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="year"
                                       id="kt_docs_maxlength_always_show" value="{{ $tractor->year }}" maxlength="4"
                                       required/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="make"
                                       id="kt_docs_maxlength_always_show" value="{{ $tractor->make }}" maxlength="30"
                                       required/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="model"
                                       id="kt_docs_maxlength_always_show" value="{{ $tractor->model }}" maxlength="30"
                                       required/>
                                <!--end::Input-->
                            </div>
                        </div>
                        ...
                        <div class="row fv-row">
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="vin"
                                       id="kt_docs_maxlength_always_show" value="{{ $tractor->vin }}" maxlength="40"
                                       required/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="owned_by"
                                       id="kt_docs_maxlength_always_show" value="{{ $tractor->owned_by }}"
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                        data-placeholder="Select an driver" name="driver_1" required>
                        ...
                        <div class="row fv-row">
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="tag"
                                       id="kt_docs_maxlength_always_show" maxlength="40" value="{{ $tractor->tag }}"
                                       required/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                        data-placeholder="Select an state" name="tag_state" required>
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input class="form-control form-control-solid" name="tag_expiration" id="tag_expiration"
                                       value="{{ $tractor->tag_expiration }}" required/>
                                <!--end::Input-->
                            </div>
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row fv-row">
                            <div class="col-md-4 fv-row">
                                ...
                                <input class="form-control form-control-solid" name="last_inspection"
                                       id="last_inspection" value="{{ $tractor->last_inspection }}" required/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        </div>
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                    ...
                    <textarea name="comments" class="form-control form-control form-control-solid"
                              data-kt-autosize="true" maxlength="50">{{ $tractor->comments }}</textarea>
                ...
                (e = document.querySelector("#tractor_form_edit")),
                    ...
                    (t = FormValidation.formValidation(e, {
                        fields: {
                            ...
                            driver_1: {
                                validators: {
                                    ...
                                    stringLength: {
                                        min: 1,
                                        max: 50,
                                        message: "Driver 1 must be more than 1 and less than 50 characters long."
                                    },
                                    regexp: {
                                        regexp: /^[a-zA-Z0-9]+$/,
                                        message: "Driver 1 can only consist of alphabetical and number"
                                    },
                                },
                            },
                            tag: {
                            ...
                            tag_state: {
                                validators: {
                                    notEmpty: {message: "Tag State field is required."},
                                    stringLength: {
                                        min: 1,
                                        max: 50,
                                        message: "Tag must be more than 1 and less than 50 characters long."
                            ...
                            tag_expiration: {
                                validators: {
                                    notEmpty: {
                                        message: "Tag Expiration field is required."},
                                    stringLength: {
                                        min: 1,
                                        max: 50,
                                        message: "Tag must be more than 1 and less than 50 characters long."
                            ...
                            last_inspection: {
                                validators: {
                                    notEmpty: {
                                        message: "Last Inspection field is required."},
                                    stringLength: {
                                        min: 1,
                                        max: 50,
                                        message: "Tag must be more than 1 and less than 50 characters long."
    ...
    $("#tag_expiration").daterangepicker(
        {
            ...
            ranges: {
                ...
                "7 Days Ago": [moment().subtract(6, "days")],
                "30 Days Ago": [moment().subtract(29, "days")]
            },
        },
        function (t) {
