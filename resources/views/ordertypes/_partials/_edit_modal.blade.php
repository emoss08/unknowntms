        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form action="{{route('ordertypes.update',$ordertypes->id)}}" method="POST" id="order_type_form_edit-{{$ordertypes->id}}" novalidate>
                        @csrf @method('PUT')
                        <div class="row mb-5">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">Description</span> <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Brief description of Order Type."></i>
                            </label>
                        ...
                        <div class="text-center pt-15">
                            ...
                            <button type="submit" id="order_type_submit_edit-{{$ordertypes->id}}" class="btn btn-primary">
