<div class="alert alert-dismissible bg-info d-flex flex-column flex-sm-row w-100 p-5 mb-10">
    ...
    <div class="d-flex flex-column text-light pe-0 pe-sm-10">
        <h4 class="mb-2 text-light">Notice!</h4>
        <span>Use Artisan Control Center commands at your own discretion. If used improperly, system malfunctions may occur! </span>
    </div>
    <!--end::Content-->
    <!--begin::Close-->
