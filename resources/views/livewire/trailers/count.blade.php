                ...
                <div class="card-body p-0">
                    ...
                    <div class="px-9 pt-7 card-rounded h-275px w-100 bg-primary">
                        ...
                        <div class="d-flex flex-stack">
                            <h3 class="m-0 text-white fw-bolder fs-3">Last Inspection</h3>
                            <div class="ms-1">
                                <!--begin::Menu-->
                        ...
                        <div class="d-flex text-center flex-column text-white pt-8">
                            ...
                            <span class="fw-bolder fs-2x pt-1">{{ $trailers_count }}</span>
                        </div>
                        <!--end::Balance-->
                    </div>
                    <!--end::Header-->
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <div class="d-flex align-items-center flex-wrap w-100">
                                    ...
                                    <div class="mb-1 pe-3 flex-grow-1">
                                        <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bolder">Trailer ID - {{ $trailer->trailer_id }}</a>
                                        <div class="text-gray-400 fw-bold fs-7">{{ $trailer->last_inspection }}</div>
                                    </div>
                                    <!--end::Title-->
                                    <!--begin::Label-->
