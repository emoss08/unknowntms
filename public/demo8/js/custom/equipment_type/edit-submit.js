"use strict";
var EquipmentType_edit = (function () {
    var t, e, i;
    return {
        init: function () {
                                    ...
                                    axios
                                        ...
                                        .then(function (e) {
                                            Swal.fire({
                                                ...
                                                e.isConfirmed && ((t.querySelector('[name="equip_type_id"]').value = ""), (t.querySelector('[name="description"]').value = ""), window.location.reload());
                                            });
                                        })
                                        .catch(function (t) {
